...
const { CreateSession, DeleteSession, ModifySessionName, AddEleveToSession, DelEleveToSession, ConnexionToSession, ViewSessions } = require('./controllers/sessions')
...
app.use('/view_sessions', ViewSessions)
